  ...
  return (
    <>
      <aside style={{
        ...
        minHeight:"100vh", position:"relative", zIndex:100,
        ...
        <div style={{ padding:"24px 20px 20px", borderBottom:`1px solid ${t.border}` }}>
          <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
            <div style={{ display:"flex", alignItems:"center", gap:10 }}>
              ...
              <div>
                <p style={{ fontSize:14, fontWeight:800, color:t.text }}>CRM Calendar</p>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:4 }}>
              ...
              <button onClick={toggleSino} style={{
                ...
                color: sinoAberto ? "#A5B4FC" : t.textMuted,
                transition:"color 0.15s"
              }}>
        ...
        <nav style={{ padding:"16px 12px" }}>
          <p style={{ fontSize:9, color:t.textDim, fontWeight:700, letterSpacing:1.5, padding:"0 8px 10px" }}>MENU</p>
        ...
        <div style={{ padding:"0 12px" }}>
          <p style={{ fontSize:9, color:t.textDim, fontWeight:700, letterSpacing:1.5, padding:"0 8px 12px" }}>FILTRAR POR MARCA</p>
          {MARCAS.map(m => {
            const active = path === `/campanhas/${m.slug}`;
            return (
              <div key={m.slug} onClick={() => navigate(`/campanhas/${m.slug}`)} style={{
                display:"flex", alignItems:"center", gap:10,
              ...
              >
                ...
                <span style={{ fontSize:12, color: active ? m.color : t.textMuted, fontWeight: active ? 600 : 400 }}>{m.label}</span>
              </div>
            );
          })}
        </div>
