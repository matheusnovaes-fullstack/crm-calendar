export default function StatusBadge({ inicio, fim }) {
  ...
  if (!start && !end) {
    label = "Sem data"; bg = "rgba(30,58,95,0.5)"; color = "#475569"; border = "#1E3A5F"; dot = "#475569";
  } else if (start && agora < start) {
    label = "Agendada"; bg = "rgba(139,92,246,0.12)"; color = "#A78BFA"; border = "rgba(139,92,246,0.3)"; dot = "#A78BFA";
  } else if (start && end && agora >= start && agora <= end) {
    label = "Rodando"; bg = "rgba(16,185,129,0.12)"; color = "#10B981"; border = "rgba(16,185,129,0.3)"; dot = "#10B981";
  } else {
